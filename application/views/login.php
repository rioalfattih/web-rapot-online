...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url('assets/components'); ?>/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>SISTEM INFORMASI RAPORT ONLINE</a>
  </div>
...
<div class="nav-tabs-custom">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo site_url('login/cek_login'); ?>" method="post">
      <input type="hidden" name="opsi" value="admin">
      ...
      <div class="row">
        <div class="col-xs-6">
          <input type="submit" name="submit" value="LOGIN ADMIN" class="btn btn-primary btn-block btn-flat">
        </div>
        <!-- /.col -->
      </div>
    </form>
  ...
  <!-- /.login-box-body -->
              ...
              <div class="tab-pane" id="siswa">
                ...
                <div class="login-box-body">
    <p class="login-box-msg">SISWA</p>

    <form action="<?php echo site_url('login/cek_login'); ?>" method="post">
      <input type="hidden" name="opsi" value="siswa">
      <div class="form-group has-feedback">
      ...
      <div class="row">
        <div class="col-xs-6">
          <input type="submit" name="submit" value="LOGIN SISWA" class="btn btn-success btn-block btn-flat">
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<!-- iCheck -->
<script src="<?php echo base_url('assets/components'); ?>/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
