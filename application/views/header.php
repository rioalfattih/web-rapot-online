      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          <a href="#">
            ...
            <li><a href="<?php echo base_url('index.php/nilai'); ?>"><i class="fa fa-dashboard"></i> <span>Nilai</span></a></li>
            <li><a href="<?php echo base_url('index.php/cetak_nilai'); ?>"><i class="fa fa-users"></i> <span>Cetak Nilai</span></a></li>
